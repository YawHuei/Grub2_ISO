...
grub-mkimage.exe -c ..\cfg\grub_cd.cfg -d i386-pc -p /grub2 -o core.img -O i386-pc linux16 linux normal iso9660 biosdisk memdisk search tar ls
...
.\xorriso\xorriso.exe -as mkisofs -iso-level 3 -full-iso9660-filenames -eltorito-boot grub/grub2.img ^
 ...
 --grub2-mbr grub2/i386-pc/boot_hybrid.img -eltorito-alt-boot -output "%tcd%/grub2.iso" -graft-points "grub=./grub2" ^
